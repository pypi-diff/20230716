# Comparing `tmp/hyfi_template-0.4.5.tar.gz` & `tmp/hyfi_template-0.4.6.tar.gz`
...
## Comparing `hyfi_template-0.4.5.tar` & `hyfi_template-0.4.6.tar`
...
### Comparing `hyfi_template-0.4.5/LICENSE` & `hyfi_template-0.4.6/LICENSE`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/README.md` & `hyfi_template-0.4.6/README.md`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/pyproject.toml` & `hyfi_template-0.4.6/pyproject.toml`
...
### Comparing `hyfi_template-0.4.5/src/hyfit/conf/batch/__init__.yaml` & `hyfi_template-0.4.6/src/hyfit/conf/batch/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/src/hyfit/conf/copier/conf.yaml` & `hyfi_template-0.4.6/src/hyfit/conf/copier/conf.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/src/hyfit/conf/dotenv/__init__.yaml` & `hyfi_template-0.4.6/src/hyfit/conf/dotenv/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/src/hyfit/conf/hydra/help/help.yaml` & `hyfi_template-0.4.6/src/hyfit/conf/hydra/help/help.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/src/hyfit/conf/mode/__init__.yaml` & `hyfi_template-0.4.6/src/hyfit/conf/mode/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/src/hyfit/conf/path/__init__.yaml` & `hyfi_template-0.4.6/src/hyfit/conf/path/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/src/hyfit/conf/project/__init__.yaml` & `hyfi_template-0.4.6/src/hyfit/conf/project/__init__.yaml`

 * *Files identical despite different names*

### Comparing `hyfi_template-0.4.5/PKG-INFO` & `hyfi_template-0.4.6/PKG-INFO`
