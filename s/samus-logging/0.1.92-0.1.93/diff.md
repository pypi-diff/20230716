# Comparing `tmp/samus-logging-0.1.92.tar.gz` & `tmp/samus-logging-0.1.93.tar.gz`
...
## Comparing `samus-logging-0.1.92.tar` & `samus-logging-0.1.93.tar`
...
### Comparing `samus-logging-0.1.92/PKG-INFO` & `samus-logging-0.1.93/PKG-INFO`
...
### Comparing `samus-logging-0.1.92/samus_logging/samus_logging.py` & `samus-logging-0.1.93/samus_logging/samus_logging.py`
...
### Comparing `samus-logging-0.1.92/samus_logging.egg-info/PKG-INFO` & `samus-logging-0.1.93/samus_logging.egg-info/PKG-INFO`
...
### Comparing `samus-logging-0.1.92/setup.py` & `samus-logging-0.1.93/setup.py`
