# Comparing `tmp/spark_sdk-0.4.23rc1-py3-none-any.whl.zip` & `tmp/spark_sdk-0.4.9-py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,18 +1,16 @@
-Zip file size: 35068 bytes, number of entries: 16
--rw-rw-r--  2.0 unx     1381 b- defN 23-Jul-16 07:52 spark_sdk/__init__.py
--rw-rw-r--  2.0 unx      772 b- defN 23-Jul-16 07:24 spark_sdk/conf.py
...
--rw-rw-r--  2.0 unx    31810 b- defN 23-Jul-16 07:46 spark_sdk/pylineage.py
--rw-rw-r--  2.0 unx    52073 b- defN 23-Jul-14 04:35 spark_sdk/pyspark_add_on.py
--rw-rw-r--  2.0 unx     4100 b- defN 23-Mar-12 15:53 spark_sdk/utils.py
--rw-rw-r--  2.0 unx       92 b- defN 22-Oct-10 08:46 spark_sdk-0.4.23rc1.dist-info/.ipynb_checkpoints/requires-checkpoint.txt
--rw-rw-r--  2.0 unx     8527 b- defN 23-Jul-16 07:52 spark_sdk-0.4.23rc1.dist-info/METADATA
--rw-rw-r--  2.0 unx       92 b- defN 23-Jul-16 07:52 spark_sdk-0.4.23rc1.dist-info/WHEEL
--rw-rw-r--  2.0 unx       10 b- defN 23-Jul-16 07:52 spark_sdk-0.4.23rc1.dist-info/top_level.txt
-?rw-rw-r--  2.0 unx     1340 b- defN 23-Jul-16 07:52 spark_sdk-0.4.23rc1.dist-info/RECORD
-16 files, 128266 bytes uncompressed, 32856 bytes compressed:  74.4%
...
-Filename: spark_sdk-0.4.23rc1.dist-info/.ipynb_checkpoints/requires-checkpoint.txt
+Filename: spark_sdk-0.4.9.dist-info/.ipynb_checkpoints/requires-checkpoint.txt
 Comment: 
 
-Filename: spark_sdk-0.4.23rc1.dist-info/METADATA
+Filename: spark_sdk-0.4.9.dist-info/METADATA
 Comment: 
 
-Filename: spark_sdk-0.4.23rc1.dist-info/WHEEL
+Filename: spark_sdk-0.4.9.dist-info/WHEEL
 Comment: 
 
-Filename: spark_sdk-0.4.23rc1.dist-info/top_level.txt
+Filename: spark_sdk-0.4.9.dist-info/top_level.txt
 Comment: 
 
-Filename: spark_sdk-0.4.23rc1.dist-info/RECORD
...
-from spark_sdk.pylineage import toPandasLineage
...
-SparkDataFrame.toPandas = toPandasLineage
 
 
 SparkDataFrame.show = show
 
-__version__ = '0.4.23rc1'
...
@@ -651,18 +549,17 @@
 ...
 class PyArrow:
     def __init__(self, existing_data_behavior='overwrite_or_ignore'):
         ...
         import os
-        from spark_sdk.config import (HADOOP_HOST, HDOOP_PORT)
 
 
-        self.hdfs = fs.HadoopFileSystem(host=HADOOP_HOST, port=HDOOP_PORT)
...
## Comparing `spark_sdk-0.4.23rc1.dist-info/METADATA` & `spark_sdk-0.4.9.dist-info/METADATA`
...
## Comparing `spark_sdk-0.4.23rc1.dist-info/RECORD` & `spark_sdk-0.4.9.dist-info/RECORD`

 * *Files 27% similar despite different names*

```diff
@@ -1,16 +1,14 @@
-spark_sdk/__init__.py,sha256=sOODO0r2aI6sWzNiAO59K0Lvyli_zjcCb3lIJD_7IMg,1381
-spark_sdk/conf.py,sha256=5qGa8cD40LHakUziPLK6sebdOHhPWhnI8Ze4Fv6gf3U,772
...
-spark_sdk/pylineage.py,sha256=Spq3os2Hn2d8xv3RhyV5gPanxyClfbZ_uvFFPwgUkZs,31810
-spark_sdk/pyspark_add_on.py,sha256=2Rv35RmqBnLFXBMxvymlj-j48A41fwAfDEZIO4zsUsI,52073
-spark_sdk/utils.py,sha256=PmfEZXaqTW9rEcJ8wxrtMRqm3QmPFyL80I9tQ4x7yIU,4100
-spark_sdk-0.4.23rc1.dist-info/.ipynb_checkpoints/requires-checkpoint.txt,sha256=ZGBYK1Crp59m1x-Y3tALQiIew3A2hUYcSce2VIX2Y90,92
-spark_sdk-0.4.23rc1.dist-info/METADATA,sha256=b9Xo5eai7L2cKkKZiO8Db5vaUZlVTR1p0JSZLv_Pm9s,8527
-spark_sdk-0.4.23rc1.dist-info/WHEEL,sha256=OqRkF0eY5GHssMorFjlbTIq072vpHpF60fIQA6lS9xA,92
-spark_sdk-0.4.23rc1.dist-info/top_level.txt,sha256=hweYK71GSSYJx1YB2cNkxNw2KWVincoyKY8AqJc00Wg,10
-spark_sdk-0.4.23rc1.dist-info/RECORD,,
