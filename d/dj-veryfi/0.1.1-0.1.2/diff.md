# Comparing `tmp/dj-veryfi-0.1.1.tar.gz` & `tmp/dj-veryfi-0.1.2.tar.gz`
...
## Comparing `dj-veryfi-0.1.1.tar` & `dj-veryfi-0.1.2.tar`
...
### Comparing `dj-veryfi-0.1.1/LICENSE` & `dj-veryfi-0.1.2/LICENSE`

 * *Files identical despite different names*

### Comparing `dj-veryfi-0.1.1/README` & `dj-veryfi-0.1.2/README.rst`
...
### Comparing `dj-veryfi-0.1.1/migrations/0001_initial.py` & `dj-veryfi-0.1.2/migrations/0001_initial.py`

 * *Files identical despite different names*

### Comparing `dj-veryfi-0.1.1/setup.cfg` & `dj-veryfi-0.1.2/setup.cfg`
