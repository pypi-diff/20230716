# Comparing `tmp/nitaq-1.2.0.tar.gz` & `tmp/nitaq-1.3.0.tar.gz`
...
## Comparing `nitaq-1.2.0.tar` & `nitaq-1.3.0.tar`
...
### Comparing `nitaq-1.2.0/nitaq/nitaq.py` & `nitaq-1.3.0/nitaq/nitaq.py`
