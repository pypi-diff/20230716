# Comparing `tmp/colorthon-2.3.9.tar.gz` & `tmp/colorthon-2.9.3.tar.gz`
...
## Comparing `colorthon-2.3.9.tar` & `colorthon-2.9.3.tar`
...
### Comparing `colorthon-2.3.9/README.md` & `colorthon-2.9.3/README.md`
