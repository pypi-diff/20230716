# Comparing `tmp/orso-0.0.87.tar.gz` & `tmp/orso-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "orso-0.0.87.tar", last modified: Sun Jul 16 18:44:46 2023, max compression
+gzip compressed data, was "orso-0.0.9.tar", last modified: Sun Mar 12 02:47:11 2023, max compression
```

## Comparing `orso-0.0.87.tar` & `orso-0.0.9.tar`

### file list

```diff
@@ -1,62 +1,26 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.846872 orso-0.0.87/
--rw-r--r--   0 runner    (1001) docker     (123)    11346 2023-07-16 18:44:31.000000 orso-0.0.87/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     2125 2023-07-16 18:44:46.846872 orso-0.0.87/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1896 2023-07-16 18:44:31.000000 orso-0.0.87/README.md
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.838872 orso-0.0.87/orso/
--rw-r--r--   0 runner    (1001) docker     (123)      156 2023-07-16 18:44:31.000000 orso-0.0.87/orso/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.838872 orso-0.0.87/orso/bitarray/
--rw-r--r--   0 runner    (1001) docker     (123)       32 2023-07-16 18:44:31.000000 orso-0.0.87/orso/bitarray/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)   232514 2023-07-16 18:44:31.000000 orso-0.0.87/orso/bitarray/cbitarray.c
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.838872 orso-0.0.87/orso/cityhash/
--rw-r--r--   0 runner    (1001) docker     (123)       66 2023-07-16 18:44:31.000000 orso-0.0.87/orso/cityhash/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)    19319 2023-07-16 18:44:31.000000 orso-0.0.87/orso/cityhash/city.cc
--rw-r--r--   0 runner    (1001) docker     (123)   237362 2023-07-16 18:44:31.000000 orso-0.0.87/orso/cityhash/cityhash.cpp
--rw-r--r--   0 runner    (1001) docker     (123)     3974 2023-07-16 18:44:31.000000 orso-0.0.87/orso/converters.py
--rw-r--r--   0 runner    (1001) docker     (123)    14589 2023-07-16 18:44:31.000000 orso-0.0.87/orso/dataframe.py
--rw-r--r--   0 runner    (1001) docker     (123)    14501 2023-07-16 18:44:31.000000 orso-0.0.87/orso/display.py
--rw-r--r--   0 runner    (1001) docker     (123)     1788 2023-07-16 18:44:31.000000 orso-0.0.87/orso/exceptions.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.838872 orso-0.0.87/orso/filters/
--rw-r--r--   0 runner    (1001) docker     (123)       78 2023-07-16 18:44:31.000000 orso-0.0.87/orso/filters/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     4454 2023-07-16 18:44:31.000000 orso-0.0.87/orso/filters/bloom_filter.py
--rw-r--r--   0 runner    (1001) docker     (123)     3457 2023-07-16 18:44:31.000000 orso-0.0.87/orso/filters/cuckoo_filter.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.842872 orso-0.0.87/orso/logging/
--rw-r--r--   0 runner    (1001) docker     (123)      142 2023-07-16 18:44:31.000000 orso-0.0.87/orso/logging/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     2922 2023-07-16 18:44:31.000000 orso-0.0.87/orso/logging/add_level.py
--rw-r--r--   0 runner    (1001) docker     (123)     1944 2023-07-16 18:44:31.000000 orso-0.0.87/orso/logging/create_logger.py
--rw-r--r--   0 runner    (1001) docker     (123)     4785 2023-07-16 18:44:31.000000 orso-0.0.87/orso/logging/google_cloud_logger.py
--rw-r--r--   0 runner    (1001) docker     (123)     1445 2023-07-16 18:44:31.000000 orso-0.0.87/orso/logging/levels.py
--rw-r--r--   0 runner    (1001) docker     (123)     4601 2023-07-16 18:44:31.000000 orso-0.0.87/orso/logging/log_formatter.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.842872 orso-0.0.87/orso/profiler/
--rw-r--r--   0 runner    (1001) docker     (123)       71 2023-07-16 18:44:31.000000 orso-0.0.87/orso/profiler/__init__.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.842872 orso-0.0.87/orso/profiler/distogram/
--rw-r--r--   0 runner    (1001) docker     (123)    15497 2023-07-16 18:44:31.000000 orso-0.0.87/orso/profiler/distogram/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     9358 2023-07-16 18:44:31.000000 orso-0.0.87/orso/profiler/profiler.py
--rw-r--r--   0 runner    (1001) docker     (123)     4383 2023-07-16 18:44:31.000000 orso-0.0.87/orso/row.py
--rw-r--r--   0 runner    (1001) docker     (123)    10053 2023-07-16 18:44:31.000000 orso-0.0.87/orso/schema.py
--rw-r--r--   0 runner    (1001) docker     (123)    10698 2023-07-16 18:44:31.000000 orso-0.0.87/orso/tools.py
--rw-r--r--   0 runner    (1001) docker     (123)     1830 2023-07-16 18:44:31.000000 orso-0.0.87/orso/types.py
--rw-r--r--   0 runner    (1001) docker     (123)      601 2023-07-16 18:44:31.000000 orso-0.0.87/orso/version.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.838872 orso-0.0.87/orso.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     2125 2023-07-16 18:44:46.000000 orso-0.0.87/orso.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)     1180 2023-07-16 18:44:46.000000 orso-0.0.87/orso.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-07-16 18:44:46.000000 orso-0.0.87/orso.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       23 2023-07-16 18:44:46.000000 orso-0.0.87/orso.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)        5 2023-07-16 18:44:46.000000 orso-0.0.87/orso.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (123)      237 2023-07-16 18:44:31.000000 orso-0.0.87/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-07-16 18:44:46.846872 orso-0.0.87/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (123)     1330 2023-07-16 18:44:31.000000 orso-0.0.87/setup.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-07-16 18:44:46.846872 orso-0.0.87/tests/
--rw-r--r--   0 runner    (1001) docker     (123)     1554 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_bitarray.py
--rw-r--r--   0 runner    (1001) docker     (123)      952 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_cityhash.py
--rw-r--r--   0 runner    (1001) docker     (123)     4777 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_converters_arrow.py
--rw-r--r--   0 runner    (1001) docker     (123)      565 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_converters_pandas.py
--rw-r--r--   0 runner    (1001) docker     (123)      565 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_converters_polars.py
--rw-r--r--   0 runner    (1001) docker     (123)     7110 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_dataframe.py
--rw-r--r--   0 runner    (1001) docker     (123)     2011 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_fetching.py
--rw-r--r--   0 runner    (1001) docker     (123)     2173 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_filter_bloom_filter.py
--rw-r--r--   0 runner    (1001) docker     (123)     1344 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_filter_cuckoo_filter.py
--rw-r--r--   0 runner    (1001) docker     (123)      950 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_profiler.py
--rw-r--r--   0 runner    (1001) docker     (123)      691 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_random.py
--rw-r--r--   0 runner    (1001) docker     (123)     4558 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_schema.py
--rw-r--r--   0 runner    (1001) docker     (123)     4195 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_schema_columns.py
--rw-r--r--   0 runner    (1001) docker     (123)     1375 2023-07-16 18:44:31.000000 orso-0.0.87/tests/test_types.py
...
### Comparing `orso-0.0.87/LICENSE` & `orso-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `orso-0.0.87/PKG-INFO` & `orso-0.0.9/PKG-INFO`
...
### Comparing `orso-0.0.87/README.md` & `orso-0.0.9/orso.egg-info/PKG-INFO`
...
### Comparing `orso-0.0.87/orso/converters.py` & `orso-0.0.9/orso/converters.py`
...
### Comparing `orso-0.0.87/orso/version.py` & `orso-0.0.9/orso/version.py`
...
### Comparing `orso-0.0.87/orso.egg-info/PKG-INFO` & `orso-0.0.9/README.md`
...
### Comparing `orso-0.0.87/setup.py` & `orso-0.0.9/setup.py`
...
### Comparing `orso-0.0.87/tests/test_fetching.py` & `orso-0.0.9/tests/test_fetching.py`
